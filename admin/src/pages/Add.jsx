    ...
    >
      ...
      <div className="w-full">
        ...
        <input
          ...
          className="rounded-md w-full max-w-[500px] px-3 py-2"
          required
        />
      </div>
      <div className="w-full">
      ...
      <div className="flex flex-col gap-2 sm:flex-row w-full sm:gap-8 ">
        ...
        <div>
          ...
          <input
            ...
            type="number"
            placeholder="price"
            className="rounded-md w-full sm:w-[120px] px-3 py-2"
            required
          />
        </div>
      </div>
      ...
      <button
        type="submit"
        className="bg-black text-white px-5 py-2 sm:py-2 rounded-full text-xs sm:text-sm"
      >
        Add Product
      </button>
    </form>
